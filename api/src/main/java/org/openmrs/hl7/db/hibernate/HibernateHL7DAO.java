...
public class HibernateHL7DAO implements HL7DAO {
	...
	public List<HL7InQueue> getAllHL7InQueues() throws DAOException {
		return sessionFactory.getCurrentSession()
		        ...
		        .setParameter(1, HL7Constants.HL7_STATUS_PENDING, StandardBasicTypes.INTEGER).list();
	}
	...
	public HL7InQueue getNextHL7InQueue() throws DAOException {
		Query query = sessionFactory.getCurrentSession()
		        ...
		        .setParameter(1, HL7Constants.HL7_STATUS_PENDING, StandardBasicTypes.INTEGER).setMaxResults(1);
		if (query == null) {
			return null;
		}
	...
	public List<HL7InArchive> getHL7InArchivesToMigrate() {
		...
		List<Predicate> predicates = getHL7SearchCriteria(cb, root, HL7InArchive.class, HL7Constants.HL7_STATUS_PROCESSED,
		    null);
		...
		return session.createQuery(cq).setMaxResults(HL7Constants.MIGRATION_MAX_BATCH_SIZE).getResultList();
	}
