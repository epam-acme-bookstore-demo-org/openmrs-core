...
public interface CohortService extends OpenmrsService {
	 ...
	 * <p>
	 * <strong>Should</strong> create new cohorts<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> fail if reason is null<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get cohort given a name<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get all nonvoided cohorts in database<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> never return null<br/>
	 ...
	 *
	 * @deprecated use {@link #getCohortsContainingPatientId(Integer)} Find all Cohorts that contain the
	 *             given patient. (Not including voided Cohorts)
	...
	/**
	 * Adds a new patient to a Cohort. If the patient is not already in the Cohort, then they are added,
	 * and the Cohort is saved, marking it as changed.
	 * <p>
	 * <strong>Should</strong> add a patient and save the cohort<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> not fail if cohort doesn't contain patient<br/>
	 * <strong>Should</strong> save cohort after removing patient
	 *
	 * @deprecated since 2.1.0 you should explicitly call either
	 *             {@link #endCohortMembership(CohortMembership, Date)} or
	 *             {@link #voidCohortMembership(CohortMembership, String)}
	 ...
	 * CHANGE WITHOUT WARNING. Used to notify this service that a patient has been voided, and therefore
	 * we should void all cohort memberships that refer to that patient
	 * <p>
	 ...
	 * therefore we should unvoid all cohort memberships that were automatically voided with the patient
	 * <p>
