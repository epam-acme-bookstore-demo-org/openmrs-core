...
public interface ProgramWorkflowService extends OpenmrsService {
	...
	/**
	 * Setter for the ProgramWorkflow DataAccessObject (DAO). The DAO is used for saving and retrieving
	 * from the database
	 *
	 ...
	 * <p>
	 * <strong>Should</strong> create program workflows<br/>
	...
	/**
	 * Returns a program given that programs primary key <code>programId</code> A null value is returned
	 * if no program exists with this programId.
	 * <p>
	 * <strong>Should</strong> return program matching the given programId<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return program when name matches<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all programs including retired when includeRetired equals
	 * true<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all programs with partial name match<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> delete program successfully<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> retire program successfully<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> unretire program successfully<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> update patient program<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return patient program with given patientProgramId<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return patient programs for given patient<br/>
	 ...
	 * <strong>Should</strong> return patient programs with dateEnrolled on or after
	 * maxEnrollmentDate<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> delete patient program from database<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> void patient program when reason is valid<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> cascade delete given concept state conversion when given cascade is
	 * true<br/>
	...
	/**
	 * Get a patient program by its uuid. There should be only one of these in the database. If multiple
	 * are found, an error is thrown.
	 * <p>
	 * <strong>Should</strong> find object given valid uuid<br/>
	 * <strong>Should</strong> return null if no object found with given uuid<br/>
	 ...
	 * <strong>Should</strong> return empty list when there is no match for given cohort and
	 * programs<br/>
	 * <strong>Should</strong> not return null when there is no match for given cohort and program<br/>
	 * <strong>Should</strong> not throw NullPointerException when given cohort and programs are
	 * null<br/>
	...
	/**
	 * Get a concept state conversion by its uuid. There should be only one of these in the database. If
