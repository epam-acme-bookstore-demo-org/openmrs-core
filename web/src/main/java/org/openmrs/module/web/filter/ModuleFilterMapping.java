...
public class ModuleFilterMapping implements Serializable {
	 ...
	 * <p>
	 * <strong>Should</strong> return false if the requestPath is null<br/>
	 * <strong>Should</strong> return true if the ModuleFilterMapping contains any matching urlPatterns
	 * for this<br/>
	 * <strong>Should</strong> return true if the ModuleFilterMapping contains any matching servletNames
	 * for this<br/>
	 ...
	 *            with the context path already removed (since module filter mappings are relative to
	 *            the context path).
	 * @return - true if the given {@link ModuleFilterMapping} matches the passed requestPath For
	 *         example: Passing a ModuleFilterMapping containing a urlPattern of "*" would return true
	 *         for any requestPath Passing a ModuleFilterMapping containing a urlPattern of "*.jsp"
	 *         would return true for any requestPath ending in ".jsp" requestPath requestPath
	 */
	 ...
	 * <p>
	 * <strong>Should</strong> return false if the patternToCheck is null<br/>
	 * <strong>Should</strong> return true if the pattern is *<br/>
	 * <strong>Should</strong> return true if the pattern is /*<br/>
	 * <strong>Should</strong> return true if the pattern matches the requestPath exactly<br/>
	 * <strong>Should</strong> return true if the pattern matches everything up to a suffix of /*<br/>
	 * <strong>Should</strong> return true if the pattern matches by extension<br/>
	...
	/**
	 * Return <code>true</code> if the specified servlet name matches the filterMapping otherwise return
	 * <code>false</code>.
	 * <p>
	 * <strong>Should</strong> return false if the patternToCheck is null<br/>
	 * <strong>Should</strong> return true if the pattern is *<br/>
	 * <strong>Should</strong> return true if the pattern matches the servlet name exactly<br/>
	 * <strong>Should</strong> return false if no pattern matches
	 *
	 * @param patternToCheck String pattern to check
