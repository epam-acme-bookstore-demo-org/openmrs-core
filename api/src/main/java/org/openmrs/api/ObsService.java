...
public interface ObsService extends OpenmrsService {
	 ...
	 * <p>
	 * <strong>Should</strong> find revision obs for given valid obs<br/>
	 ...
	 * </p>
	 * <p>
	 * <strong>Should</strong> create new file from complex data for new obs<br/>
	 ...
	 * @param changeMessage String explaining why <code>obs</code> is being changed. If <code>obs</code>
	 *            is a new obs, changeMessage is nullable, or if it is being updated, it would be
	 *            required
	 ...
	 * <p>
	 * <strong>Should</strong> set voided bit on given obs<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> unset voided bit on given obs<br/>
	 ...
	 * we don't want to ever lose data. The data really <i>should</i> be voided and then it is not seen
	 * in interface any longer (see #voidObs(Obs) for that one) If other things link to this obs, an
	 ...
	 * Completely remove an observation from the database. This should typically not be called because
	 * we don't want to ever lose data. The data really <i>should</i> be voided and then it is not seen
	 * in interface any longer (see #voidObs(Obs) for that one)
	 * <p>
	 * <strong>Should</strong> throw APIException if given true cascade<br/>
	...
	/**
	 * This method fetches observations according to the criteria in the given arguments. All arguments
	 * are optional and nullable. If more than one argument is non-null, the result is equivalent to an
	 * "and"ing of the arguments. (e.g. if both a <code>location</code> and a <code>fromDate</code> are
	 * given, only Obs that are <u>both</u> at that Location and after the fromDate are returned). <br>
	 * <br>
	 ...
	 * parameter<br/>
	 * <strong>Should</strong> get the count of all obs with answer concept in given answers
	 * parameter<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get obs matching patient identifier in searchString<br/>
	 ...
	 * concept (conceptId)
	 * <p>
	 * <strong>Should</strong> get observations matching person and question<br/>
	...
	/**
	 * Get a complex observation. If obs.isComplex() is true, then returns an Obs with its ComplexData.
	 * Otherwise returns a simple Obs.
	 * <p>
	 * <strong>Should</strong> fill in complex data object for complex obs<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get handler with matching key<br/>
	...
	/**
	 * <u>Add</u> the given map to this service's handlers. This method registers each ComplexObsHandler
	 * to this service. If the given String key exists, that handler is overwritten with the given
	 * handler For most situations, this map is set via spring, see the applicationContext-service.xml
	 * file to add more handlers.
	 * <p>
	 * <strong>Should</strong> override handlers with same key<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> remove handler with matching key<br/>
	...
	/**
	 * Gets the number of observations(including voided ones) that are using the specified conceptNames
	 * as valueCodedName answers
	 * <p>
	 * <strong>Should</strong> return the count of all observations using the specified conceptNames as
	 * answers<br/>
	 * <strong>Should</strong> include voided observations using the specified conceptNames as
	 * answers<br/>
