 ...
 * the classpath.
 *
 * @deprecated As of 2.7.0, replaced by the usage of {@link #search(String, boolean)} or
 *             {@link #getAll(String)}, as this provides a better handling of paths that map to
 *             multiple resources using Liquibase's DUPLICATE_FILE_MODE. Refer to
 *             {@link liquibase.GlobalConfiguration#DUPLICATE_FILE_MODE} for the configuration and
 *             usage details.
 */
@Deprecated
