...
public class Diagnosis extends BaseCustomizableData<DiagnosisAttribute> implements FormRecordable {
	 ...
	 */
	public Diagnosis(Encounter encounter, CodedOrFreeText diagnosis, ConditionVerificationStatus certainty, Integer rank,
	    Patient patient, String formNamespaceAndPath) {
		this.encounter = encounter;
		this.diagnosis = diagnosis;
		this.certainty = certainty;
		this.rank = rank;
	 ...
	 * <p>
	 * <strong>Should</strong> return the namespace for a form field with or without a path otherwise
	 * null
	 *
	 ...
	 * <p>
	 * <strong>Should</strong> return the path for a form field with or without a namespace otherwise
	 * null
	 *
