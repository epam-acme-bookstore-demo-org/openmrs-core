...
public class CustomResourceLoader {
		...
		try {
			...
			for (Resource localeResource : localResources) {
				...
				ResourceBundle rb = new PropertyResourceBundle(
				        new InputStreamReader(localeResource.getInputStream(), StandardCharsets.UTF_8));
	 ...
	 *            be loaded. If this isn't specified then <code>${CONTEXT-ROOT}/WEB-INF/</code> will be
	 *            used
