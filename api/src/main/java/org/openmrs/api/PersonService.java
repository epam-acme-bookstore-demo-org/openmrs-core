...
public interface PersonService extends OpenmrsService {
	...
	/**
	 * These enumerations are used when determining which person attr types to display. If listing off a
	 * lot of patients/users, one set of types are shown. When only displaying one patient/user, another
	 * type is shown.
	 */
	 ...
	 * well. Any person with a null/missing birthdate is included and anyone with a birthyear plus/minus
	 * one year from the given <code>birthyear</code> is also included
	 * <p>
	 * <strong>Should</strong> accept greater than three names<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> set the date created and creator on new<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> throw an error when trying to retire person attribute type while person
	 * attribute types are locked
	 *
	 * @param type
	 * @param retiredReason
	 ...
	 * <p>
	 * <strong>Should</strong> delete person attribute type from database<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> restore person attribute type from database<br/>
	 * <strong>Should</strong> throw an error when trying to unretire person attribute type while person
	 * attribute types are locked
	 *
	 ...
	 * <p>
	 * <strong>Should</strong> return voided person with given reason<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> unvoid the given person<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all person attribute types including retired when include retired
	 * is true<br/>
	 * <strong>Should</strong> return all person attribute types excluding retired when include retired
	 * is false
	 *
	 ...
	 * results
	 * <p>
	 * <strong>Should</strong> return person attribute types matching given parameters<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return null when PersonAttribute with given id does not exist<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return person attribute type when name matches given typeName<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return relationship with given id<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all relationship including voided when include voided equals
	 * true<br/>
	...
	/**
	 * Get list of relationships that include Person in person_id or relative_id Does not include voided
	 * relationships
	 * <p>
	 * <strong>Should</strong> only get unvoided relationships<br/>
	 ...
	 * include those that have a startDate that is null or less than or equal to the effectiveDate, and
	 * that have an endDate that is null or greater than or equal to the effectiveDate.
	 * <p>
	 * <strong>Should</strong> only get unvoided relationships<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> fetch relationships matching the given from person<br/>
	 ...
	 * <strong>Should</strong> fetch relationships matching the given to person<br/>
	 * <strong>Should</strong> fetch relationships matching the given rel type<br/>
	 * <strong>Should</strong> return empty list when no relationship matching given parameters
	 * exist<br/>
	 * <strong>Should</strong> fetch relationships that were active during effectiveDate
	 *
	 * @param fromPerson (optional) Person to in the person_id column
	 ...
	 * @param toPerson (optional) Person in the relative_id column
	 * @param relType (optional) The RelationshipType to match
	 * @param startEffectiveDate (optional) The date during which the relationship was effective (lower
	 *            bound)
	 ...
	 * <p>
	 * <strong>Should</strong> return relationship type with the given relationship type id<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return list of preferred relationship type matching given name<br/>
	...
	/**
	 * Create or update a relationship between people. Saves the given <code>relationship</code> to the
	 * database
	 * <p>
	 * <strong>Should</strong> create new object when relationship id is null<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> create new object when person id is null<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> find PersonName given valid personNameId<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> create new object when relationship type id is null<br/>
	 ...
	 *
	 * @param personType PERSON, USER, PATIENT, or null. Both PERSON and null mean to return attr types
	 ...
	 * <p>
	 * <strong>Should</strong> parse two person name with comma<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> require PersonMergeLogData<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> require uuid<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> retrieve all PersonMergeLogs from the model<br/>
	...
	/**
	 * Voids the given PersonAddress, effectively deleting the personAddress, from the end-user's point
	 * of view.
	 * <p>
