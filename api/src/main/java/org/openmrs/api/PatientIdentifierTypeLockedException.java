...
public class PatientIdentifierTypeLockedException extends APIException {
	...
	/**
	 * Generic constructor that gives a normal reason why the user is not being allowed to manipulate of
	 * a patient identifier type.
	 */
	 ...
	 * the error message for the user as to why an exception is being thrown. The
	 * {@link #PatientIdentifierTypeLockedException(String, Throwable)} constructor is preferred over
	 * this one.
	 *
	 * @param cause the parent exception
	 */
