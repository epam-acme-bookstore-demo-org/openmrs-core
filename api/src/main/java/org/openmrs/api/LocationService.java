...
public interface LocationService extends OpenmrsService {
	 ...
	 * <p>
	 * <strong>Should</strong> throw APIException if location has no name<br/>
	...
	/**
	 * Returns a location given the location's exact <code>name</code> A null value is returned if there
	 * is no location with this name
	 * <p>
	 ...
	 * <p>
	 * <strong>Should</strong> return default location for the implementation<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all locations when includeRetired is true<br/>
	...
	/**
	 * Gets the locations matching the specified arguments. A null list will never be returned. An empty
	 * list will be returned if there are no locations. Search is case insensitive. matching this
	 * <code>nameFragment</code>. If start and length are not specified, then all matches are returned.
	 * <p>
	 * <strong>Should</strong> return empty list when no location has matching attribute values<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get locations by tag<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get locations having all tags<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> get locations having any tag<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> throw APIException if tag has no name<br/>
	 * <strong>Should</strong> return saved object<br/>
	...
	/**
	 * Returns a location tag given that locations primary key <code>locationTagId</code>. A null value
	 * is returned if no tag exists with this ID.
	 * <p>
	 ...
	 * <p>
	 * <strong>Should</strong> get location tag by name<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all location tags if includeRetired is true<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> retire location tag successfully<br/>
	...
	/**
	 * Unretire the given location tag. This restores a previously retired tag back into circulation and
	 * use.
	 * <p>
	...
	/**
	 * Return the number of all locations that start with the given name fragment, if the name fragment
	 * is null or an empty string, then the number of all locations will be returned
	 *
	 * @param nameFragment is the string used to search for locations
	...
	/**
	 * Returns all root locations (i.e. those who have no parentLocation), optionally including retired
	 * ones.
	 * <p>
	 * <strong>Should</strong> return all root locations when includeRetired is true<br/>
	 ...
	 * method is not implemented in core, but is meant to overridden by implementing modules such as the
	 * Address Hierarchy module.
	 * <p>
	 * <strong>Should</strong> return empty list if no possible address matches<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> throw APIException if the string is empty<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> create a new location attribute type<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return the location attribute type with the specified name<br/>
