...
public class Reflect {
	 ...
	 * class<br/>
	 * <strong>Should</strong> return false if given subClass is not accessible from given parameterized
	 * class
	 *
	 ...
	 * type
	 * <p>
	 * <strong>Should</strong> return true if given field is Collection and its element type is given
	 * parameterized<br/>
	 * <strong>Should</strong> return false if given field is not a Collection<br/>
	 * <strong>Should</strong> return false if given field is Collection and element type is other than
	 * given
	 *
	 * @param field Field
